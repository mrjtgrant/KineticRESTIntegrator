...
namespace Keri.Epicor
{
    ...
    public class VendorSvc : EpicorSvc
    {
        ...
        /// <summary>
        /// Retrieves a vendor by ID and hands back its <c>Vendor</c> row as
        /// <typeparamref name="T"/>.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </remarks>
        /// <typeparam name="T">
        /// A type whose properties are named after the <c>Vendor</c> columns —
        /// the bundled <see cref="Keri.Epicor.Dtos.Vendor"/>, or your own.
        /// </typeparam>
        /// <param name="vendorNum">The Epicor vendor number to retrieve.</param>
        /// <param name="ct">Cancellation token.</param>
        /// <returns>
        /// The <c>Vendor</c> row as <typeparamref name="T"/>, or a null
        /// <c>Value</c> when there is no such row.
        /// </returns>
        /// <example>
        /// <code>
        /// var result = await client.Vendor.GetByIDAsync&lt;Vendor&gt;(1234);
            ...
            CancellationToken ct = default) where T : class
        {
            return AsPrimaryRow<T>(
                await GetByIDAsync(vendorNum, ct).ConfigureAwait(false), "Vendor");
        }
