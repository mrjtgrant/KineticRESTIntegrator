...
namespace Keri.Epicor
{
    ...
    public partial class QuoteSvc : EpicorSvc
    {
        ...
        public QuoteSvc(EpicorRestSessionKey session, HttpClient client) : base(session, client) { }
        ...
        /// <summary>
        /// Retrieves a quote by ID and hands back its <c>QuoteHed</c> row as
        /// <typeparamref name="T"/>.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </remarks>
        /// <typeparam name="T">
        /// A type whose properties are named after the <c>QuoteHed</c> columns —
        /// the bundled <see cref="Keri.Epicor.Dtos.QuoteHed"/>, or your own.
        /// </typeparam>
        /// <param name="quoteNum">The quote number to retrieve.</param>
        /// <param name="ct">Cancellation token.</param>
        /// <returns>
        /// The <c>QuoteHed</c> row as <typeparamref name="T"/>, or a null
        /// <c>Value</c> when there is no such row.
        /// </returns>
        /// <example>
        /// <code>
        /// var result = await client.Quote.GetByIDAsync&lt;QuoteHed&gt;(4567);
            ...
            CancellationToken ct = default) where T : class
        {
            return AsPrimaryRow<T>(
                await GetByIDAsync(quoteNum, ct).ConfigureAwait(false), "QuoteHed");
        }
