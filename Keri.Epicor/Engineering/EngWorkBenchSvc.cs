...
namespace Keri.Epicor
{
    ...
    public partial class EngWorkBenchSvc : EpicorSvc
    {
        ...
        /// <summary>
        /// Retrieves a ECO group by ID and hands back its <c>ECOGroup</c> row as
        /// <typeparamref name="T"/>.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </remarks>
        /// <typeparam name="T">
        /// A type whose properties are named after the <c>ECOGroup</c> columns —
        /// the bundled <see cref="Keri.Epicor.Dtos.ECOGroup"/>, or your own.
        /// </typeparam>
        /// <param name="groupID">The ECO group ID to retrieve.</param>
        /// <param name="ct">Cancellation token.</param>
        /// <returns>
        /// The <c>ECOGroup</c> row as <typeparamref name="T"/>, or a null
        /// <c>Value</c> when there is no such row.
        /// </returns>
        /// <example>
        /// <code>
        /// var result = await client.EngWorkBench.GetByIDAsync&lt;ECOGroup&gt;("ECO-2026-01");
            ...
            CancellationToken ct = default) where T : class
        {
            return AsPrimaryRow<T>(
                await GetByIDAsync(groupID, ct).ConfigureAwait(false), "ECOGroup");
        }
