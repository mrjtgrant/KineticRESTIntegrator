...
namespace Keri.Epicor
{
    ...
    public partial class InvTransferSvc : EpicorSvc
    {
        ...
        public InvTransferSvc(EpicorRestSessionKey session, HttpClient client) : base(session, client) { }
        ...
        /// <inheritdoc/>
        /// <remarks>Also disposes the inner <see cref="SelectedSerialNumbersSvc"/>.</remarks>
