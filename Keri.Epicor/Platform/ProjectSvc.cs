...
namespace Keri.Epicor
{
    ...
    public partial class ProjectSvc : EpicorSvc
    {
        ...
        public ProjectSvc(EpicorRestSessionKey session, HttpClient client) : base(session, client) { }
        ...
        /// <summary>
        /// Retrieves a project by ID and hands back its <c>Project</c> row as
        /// <typeparamref name="T"/>.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </remarks>
        /// <typeparam name="T">
        /// A type whose properties are named after the <c>Project</c> columns —
        /// the bundled <see cref="Keri.Epicor.Dtos.Project"/>, or your own.
        /// </typeparam>
        /// <param name="projectID">The project ID to retrieve.</param>
        /// <param name="ct">Cancellation token.</param>
        /// <returns>
        /// The <c>Project</c> row as <typeparamref name="T"/>, or a null
        /// <c>Value</c> when there is no such row.
        /// </returns>
        /// <example>
        /// <code>
        /// var result = await client.Project.GetByIDAsync&lt;Project&gt;("PRJ-01");
            ...
            CancellationToken ct = default) where T : class
        {
            return AsPrimaryRow<T>(
                await GetByIDAsync(projectID, ct).ConfigureAwait(false), "Project");
        }
